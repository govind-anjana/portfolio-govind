    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        ...
        >
          ...
          <motion.div
            variants={item}
            className="text-xl sm:text-3xl text-slate-200 font-semibold mb-6 min-h-[2.5rem]"
          >
            I build web apps as a <TypingWords />
          </motion.div>
          ...
          >
            Full Stack Engineer specializing in crafting modern,
            high-performance web applications with the{" "}
            <span className="text-purple-400 font-medium">MERN stack</span> and
            Tailwind CSS.
          </motion.p>
          ...
          <motion.div
            variants={item}
            className="flex flex-wrap items-center justify-center gap-6 pt-2 border-t border-white/10 max-w-lg mx-auto"
          >
