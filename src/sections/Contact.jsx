...
export default function Contact() {
  ...
  const handleChange = (e) => {
    ...
    if (touched[name]) {
      const newErrors = validate(nextForm);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          >
            {contactItems.map(({ icon: Icon, label, value, href }) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-xs text-slate-400 uppercase tracking-wider mb-0.5 font-semibold">
                    {label}
                  </p>
                  <p className="text-sm font-bold text-slate-100 group-hover:text-purple-300 transition-colors truncate">
                    {value}
                  </p>
                </div>
              </motion.a>
            ...
            <motion.div variants={fadeLeft} className="pt-2">
              <p className="text-xs text-slate-400 uppercase tracking-wider mb-3.5 font-semibold">
                Connect with Govind
              </p>
            ...
            >
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                Need a Full Stack MERN Developer or React Specialist for your
                next project? Reach out directly via form or email.
              </p>
            </motion.div>
          </motion.div>
